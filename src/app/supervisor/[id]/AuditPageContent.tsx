...
export default async function AuditPageContent({
  ...
  if (!Number.isInteger(id)) return <NotFoundCard backHref={backHref} />;
  ...
  if (!decl) return <NotFoundCard backHref={backHref} />;
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        ...
        <Link href={backHref} className="text-sm font-semibold text-gov no-print">
          تدقيق معاملة أخرى
        </Link>
      </div>
      ...
      <AuditForm
        ...
        defaults={defaults}
        headSupervisorMode={headSupervisorMode}
      />
